...
struct common_params {
    ...
    int32_t n_outputs_max         =     0; // max outputs in a batch (0 = n_batch); caps the worst-case total output count used to reserve graph/logits buffers, independent of n_parallel (KV slot capacity)
