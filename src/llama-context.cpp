...
void llama_context::set_embeddings_nextn_raw(bool value) {
    LLAMA_LOG_DEBUG("%s: value = %d\n", __func__, value);

    cparams.embeddings_nextn_raw = value;
}
...
void llama_set_embeddings_nextn_raw(llama_context * ctx, bool value) {
    ctx->set_embeddings_nextn_raw(value);
}
